            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col justify-center gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    key={i}
                    className="xl:py-4 lg:px-3 py-2 px-3 text-xs xl:text-base opacity-50
                    xl:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
              ...
              <div className="flex flex-col justify-center gap-3 md:gap-3 lg:gap-8">
                {rightLists.map((item, i) => (
                  <span
                    key={i}
                    className="xl:py-4 xl:px-3 py-2 px-3 text-xs xl:text-base opacity-50 
                    xl:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
